...
//        
        try {
            obj1 = or.Load("./pasto/pasto.obj");
            System.out.println("Objeto  cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }

        try {
            obj2 = or.Load("./low_poly_tree/Lowpoly_tree_sample.obj");
        ...
        try {
            obj3 = or.Load("./helecopter/chopper.obj");
        ...
        try {
            obj4 = or.Load("./House/House.obj");
            System.out.println("Objeto 3 cargado :" + this.fileName);
        } catch (IOException ioe) {
            System.out.println(ioe.getMessage());
        }
        try {
            obj5 = or.Load("./low_poly_tree/Lowpoly_tree_sample.obj");
